# market-core-dashboard-panel Specification

## Purpose

Define the Dashboard market core data panel, latest-data loading, metric display, and single-metric trend chart behavior.
